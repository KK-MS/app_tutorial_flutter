...
void main() => runApp(FlutterEchart());

class FlutterEchart extends StatelessWidget {
  @override
        ...
        child: Center(
          child: Column(
            children: <Widget>[
              ...
              Text('Example of Graph plot for X and Z Axis'),
                  ...
                  option: '''
                    {
                      ...
                      yAxis: {
                        ...
                        splitArea: {
                          show: true,
                          areaStyle: {
                            color: ['rgba(200,150,150,0.0)', 'rgba(200,150,150,0.05)'],
                          },
                        },
                      },
                      series: [{
                        ...
                        itemStyle: {
                          normal: {
                            ...
                            color: {
                              ...
                              colorStops: [
                                {
                                  offset: 0, color: '#24001B',
                                },
                                {
                                  offset: 1, color: '#428B00',
                                },
                              ],
                            },
                          },
              ...
              Text('Multiple Y-Axis with Single X-Axis'),
              //Text('- tap the bar and trigger the snack'),
              Container(
                //color: ['#3398DB'],
                child: Echarts(
                        ...
                        itemStyle: {
                          normal: {
                            ...
                            color: {
                              ...
                              colorStops: [
                                {
                                  offset: 0, color: '#7A8B00',
                                },
                                {
                                  offset: 1, color: '#7A8B00',
                                },
                              ],
                            },
                          },
                        ...
                        itemStyle: {
                          normal: {
                            ...
                            color: {
                              ...
                              colorStops: [
                                {
                                  offset: 0, color: '#7A8BF9',
                                },
                                {
                                  offset: 1, color: '#7A8BF9',
                                },
                              ],
                            },
                          },
